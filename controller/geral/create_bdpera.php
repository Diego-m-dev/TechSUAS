...
'
  ...
  --
  -- Host: 127.0.0.1:3306
  -- Generation Time: Nov 17, 2024 at 01:40 PM
  ...
  --
  -- Database: `Vaviável com o nome do BD`
  --
  ...
  CREATE DEFINER=`$_SESSION["nome_bd"]`@`127.0.0.1` PROCEDURE `atualizar_status_familia` ()  BEGIN
  ...
  CREATE TABLE `status_familia` (
    `id` int(11) NOT NULL,
    `cod_familiar` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  ...
  --
  -- Indexes for table `averenda`
  --
  ALTER TABLE `averenda`
    ADD PRIMARY KEY (`id`);
  
  --
  -- Indexes for table `cadastros_excluidos`
  --
  ALTER TABLE `cadastros_excluidos`
    ADD PRIMARY KEY (`id`);
  
  --
  -- Indexes for table `cadastro_forms`
  --
  ...
  --
  -- Indexes for table `carga_justify`
  --
  ALTER TABLE `carga_justify`
    ADD PRIMARY KEY (`id`);
  ...
  --
  -- Indexes for table `fichario`
  --
  ALTER TABLE `fichario`
    ADD PRIMARY KEY (`id`);
  
  --
  -- Indexes for table `ficharios`
  --
  ALTER TABLE `ficharios`
    ADD PRIMARY KEY (`id`),
    ADD UNIQUE KEY `unique_arm_gav_pas` (`arm`,`gav`,`pas`);
  
  --
  -- Indexes for table `historico_parecer_visita`
  --
  ALTER TABLE `historico_parecer_visita`
    ADD PRIMARY KEY (`id`);
  
  --
  -- Indexes for table `membros_familia`
  --
  ...
  --
  -- Indexes for table `ponto_eletronico`
  --
  ...
  --
  -- Indexes for table `status_familia`
  --
  ALTER TABLE `status_familia`
    ADD PRIMARY KEY (`id`),
    ADD UNIQUE KEY `cod_familiar` (`cod_familiar`);
  
  --
  -- Indexes for table `tbl_tudo`
  --
  ALTER TABLE `tbl_tudo`
    ADD PRIMARY KEY (`id`);
  
  --
  -- Indexes for table `unipessoal`
  --
  ALTER TABLE `unipessoal`
    ADD PRIMARY KEY (`id`);
  
  --
  -- Indexes for table `visitas_feitas`
  --
  ...
  --
  -- AUTO_INCREMENT for table `averenda`
  --
  ALTER TABLE `averenda`
    MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
  
  --
  -- AUTO_INCREMENT for table `cadastros_excluidos`
  --
  ALTER TABLE `cadastros_excluidos`
    MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
  
  --
  -- AUTO_INCREMENT for table `cadastro_forms`
  --
  ALTER TABLE `cadastro_forms`
    MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
  ...
  --
  -- AUTO_INCREMENT for table `carga_justify`
  --
  ALTER TABLE `carga_justify`
    MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
  ...
  --
  -- AUTO_INCREMENT for table `fichario`
  --
  ALTER TABLE `fichario`
    MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
  
  --
  -- AUTO_INCREMENT for table `ficharios`
  --
  ALTER TABLE `ficharios`
    MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
  
  --
  -- AUTO_INCREMENT for table `historico_parecer_visita`
  --
  ALTER TABLE `historico_parecer_visita`
    MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
  
  --
  -- AUTO_INCREMENT for table `membros_familia`
  --
  ALTER TABLE `membros_familia`
    MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
  
  --
  -- AUTO_INCREMENT for table `ponto_eletronico`
  --
  ALTER TABLE `ponto_eletronico`
    MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
  ...
  --
  -- AUTO_INCREMENT for table `status_familia`
  --
  ALTER TABLE `status_familia`
    MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
  
  --
  -- AUTO_INCREMENT for table `tbl_tudo`
  --
  ALTER TABLE `tbl_tudo`
    MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
  
  --
  -- AUTO_INCREMENT for table `unipessoal`
  --
  ALTER TABLE `unipessoal`
    MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
  
  --
  -- AUTO_INCREMENT for table `visitas_feitas`
  --
  ALTER TABLE `visitas_feitas`
    MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
  ...
  CREATE DEFINER=`$_SESSION["nome_bd"]`@`127.0.0.1` EVENT `atualizar_status_familia_event` ON SCHEDULE EVERY 1 DAY STARTS "2024-07-26 16:30:12" ON COMPLETION NOT PRESERVE ENABLE DO CALL atualizar_status_familia()$$
