...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $nisSelecionados = json_decode($_POST['nis_selecionados']);

    ?>

    <a href="/TechSUAS/views/cadunico/visitas/visitas_para_fazer_data">
    ...
    // Agora você pode processar os NIS como desejar
    foreach ($nisSelecionados as $nis) {

      $sql_dados = "SELECT cod_familiar_fam, dat_atual_fam, nom_pessoa, num_cep_logradouro_fam, nom_localidade_fam, nom_tip_logradouro_fam, nom_titulo_logradouro_fam, nom_logradouro_fam, num_logradouro_fam, des_complemento_fam, des_complemento_adic_fam, txt_referencia_local_fam FROM tbl_tudo  WHERE num_nis_pessoa_atual LIKE '%$nis%'";
