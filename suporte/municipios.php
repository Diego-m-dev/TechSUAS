    ...
    <div class="container">
      ...
      <div class="hideall">
        <div id="formCadMunicipio">
          <form action="/TechSUAS/suporte/controller/salva_mun.php" method="POST" id="form_municipio"
            class="esconde_form">
        ...
        <form action="/TechSUAS/suporte/controller/salva_setor" method="POST" id="formCadSetor" class="esconde_form">
          ...
          <input type="text" id="cod_ibge_2" name="cod_ibge_2" placeholder="Digite o código IBGE"
            onblur="buscarMunicipio()">
        ...
        <!--CADASTRO DE SISTEMA-->
        <form action="/TechSUAS/suporte/controller/salva_sys.php" method="POST" id="formCadSistemas"
          class="esconde_form">
        ...
        <form action="/TechSUAS/controller/geral/processo_cad_user" method="POST" id="formCadoperador"
          class="esconde_form">
          ...
          <select id="selectSystem" name="sistema" required>
            <option value="" disabled selected hidden>Selecione</option>
          </select>

          <label>Setor:</label>
          <select name="setor" required onchange="buscarSistemaPorSetor()">
            <option value="" disabled selected hidden>Selecione</option>
            <?php
        ...
        <form action="/TechSUAS/suporte/controller/bd_munic" method="POST" class="esconde_form" id="form_bd">
          ...
          <input type="text" id="cod_ibge_3" name="cod_ibge_3" placeholder="Digite o código IBGE"
            onblur="buscarMunicipiobd()" />
