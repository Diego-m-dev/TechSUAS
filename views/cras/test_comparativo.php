...
?>
                ...
                <form id="visitaForm">
                    ...
                    <span id="numero_parecer"><?php echo $numero_parecer_formatado; ?>/<?php echo $ano_atual; ?></span>
...
<?php
            ...
            echo '<span id="codigo_familiar">CÓDIGO FAMILIAR: '. $codigo_formatado . '</span>';

                //DATA DA ULTIMA ATUALIZAÇÃO FORMATADA E EXIBINDO
                $data = $dados_tudo['dat_atual_fam'];
                    if (!empty($data)) {
            ...
            echo '<span id="data_entrevista">DATA DA ENTREVISTA: '. $data_formatada . '</span>';

            //RENDA PERCAPITA FORMATADA E EXIBIDA
            echo '<span id="renda_per_capita">RENDA PER CAPITA DA FAMÍLIA: R$ '. $dados_tudo['vlr_renda_media_fam'] . ',00</span>';
                    ?>
...
?>
                    <button type="button" onclick="imprimirParecer()">IMPRIMIR</button>
                </form>
                <?php
            }
        }
