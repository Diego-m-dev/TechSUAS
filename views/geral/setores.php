...
<head>
    ...
    <link rel="stylesheet" href="/TechSUAS/css/geral/style-cadast-setores.css">
...
<body>
    <div class="img">
        <h1 class="titulo-com-imagem">
            <img class="titulo-com-imagem" src="/TechSUAS/img/geral/h1-setores.svg" alt="Titulocomimagem">
        </h1>
    </div>
    <div class="container">
        <div class="blocott">
            <div class="bloco1">
                <form method="post" action="/TechSUAS/controller/geral/salva_setor">
                    <div>
