...
<head>
    ...
    <link rel="stylesheet" type="text/css" href=/TechSUAS/css/cadunico/declaracoes/style_novorf.css>
    ...
    <title>Declaração de Substituição de Responsável Legal - TechSUAS</title>
...
<div><img src="/TechSUAS/img/cadunico/declaracoes/brasao.png" alt="TECHSUAS" width="80px" height="80px"></div>
    ...
    ?>
            ...
            <tr>
                <td  width="325px">VALIDADE DESTE DOCUMENTO:
                    <p><?php echo 'DE '. $data_hj . ' A '. $data_prazo ?>
                    (máximo de um mês)</p>
                </td>
                <td  width="325px"><p>Sr. Caixa Executivo,</p>
                    <p class="cont">Esta declaração confere ao portador, devidamente identificado, durante o período de validade, direito ao saque de benefícios por meio de guia de retirada individual, devendo ser arquivada cópia da mesma nos arquivos da agência</p>
                </td>
            </tr>
            </table>

            <h5>INSTRUÇÃO OPERACIONAL Nº12 SENARC/MDS</h5>
            <div class="no-print">
