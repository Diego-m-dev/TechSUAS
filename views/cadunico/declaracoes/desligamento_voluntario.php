...
?>
    ...
    <div class="no-print">
        ...
        <p>Eu, <b><?php echo $dados_tbl['nom_pessoa']; ?></b> beneficiária(o) do Programa Bolsa Família (PBF), solicito meu desligamento voluntário do referido Programa, com a atualização cadastral no Cadastro Único para Programas Socias do Governo Federal (CadÚnico) e o registro da minha renda atual e/ou outras informações relevantes para o meu cadastro.</p>
