...
?>
    <script>
        Swal.fire({
                ...
                <input type="text" name="nome_enc" id="nome_enc" placeholder="Digite o nome" />
            ...
            didOpen: () => {
                ...
                if (result.isConfirmed) {
                    ...
                    $('#carimbo').text(`São Bento do Una - PE, <?php echo $data_formatada; ?>.`)
                    ...
                    $('#linha_ass').text('___________________________________________________________________________')
        ...
        <p><span id="encaminho"></span><strong><span id="nome_wen"></span></strong><span id="cpf"></span><strong><span id="cpf_wen"></span></strong><span id="reside"></span><strong><span id="end_wen"></span></strong>.</p>
...
?>
    ...
    <p><span id="mostrarText"></span></p>
        ...
        <p><span id="linha_ass"></span></p>
        <div id="vs" style="display: none;">
            <p><?php echo $_SESSION['nome_usuario']; ?><br><?php echo $_SESSION['cargo_usuario'] . ' ' . $_SESSION['setor']; ?><br><?php echo $_SESSION['id_cargo']; ?></p>
        </div>
    <div class="no-print">
...
?>
    ...
    <p>São Bento do Una - PE, <?php echo $data_formatada; ?>.</p>
...
?>
    <!--CORPO-->
    <p>Assunto:</p>
    <p>Encaminho <?php echo  $dados_enc['cod_sexo_pessoa'] == "1" ? " o Sr. " : " a Sra. "; ?> <strong><?php echo $dados_enc['nom_pessoa']; ?></strong>, CPF: <strong><?php echo $_POST['cpf_dec_cad']; ?>, </strong> <?php echo  $dados_enc['cod_sexo_pessoa'] == "1" ? " filho " : " filha "; ?> de <strong><?php echo $dados_enc['nom_completo_mae_pessoa']; ?></strong>, reside em 
...
<?php echo $dados_user['nome']; ?><br><?php echo $dados_user['cargo'] . ' ' . $dados_user['setor']; ?><br><?php echo $dados_user['id_cargo'];
    }
?>
