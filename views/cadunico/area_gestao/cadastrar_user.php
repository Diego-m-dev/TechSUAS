...
<head>
    ...
    <title>Cadastro de Operadores - TechSUAS</title>
</head>
<body>
<div class="img">
  ...
  <form method="post" action="/TechSUAS/controller/geral/cad_user.php">
    <div class="container">
    ...
    <select name="setor" required>
      ...
      <?php
                        ...
                        $sql_setor = "SELECT setores_id FROM sistemas WHERE id = '$idSistema'";
